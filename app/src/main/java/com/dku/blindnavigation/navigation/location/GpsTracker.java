...
public class GpsTracker extends Service implements LocationListener {
    ...
    public void getLocation() {
        try {
            ...
            if (isNetworkEnabled) getLocationFromManager(LocationManager.NETWORK_PROVIDER);
            if (isGPSEnabled) getLocationFromManager(LocationManager.GPS_PROVIDER);
        } catch (Exception e) {
            Log.d("GpsTracker", "" + e);
        }
    ...
    private void getLocationFromManager(String provider) {
        ...
        if (locationManager != null) location = locationManager.getLastKnownLocation(provider);
    }
